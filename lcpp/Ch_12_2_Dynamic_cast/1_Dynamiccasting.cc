...
// Also Note That There are several cases when downcasting with dynamic_cast will not work
// 1. with Protected and private inheritance
// 2. for the Classes which donot have declare or inherit the virtual function or whre class doesn't have any virtual table
//
